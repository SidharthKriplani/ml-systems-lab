...
- [ ] **Expand MCQ explanations to include production failure mode + recognition signal** — CombinatorTab and TrainerTab explanations state the correct answer but don't build transferable judgment. Every explanation needs: what goes wrong in production if you get this wrong, and the signal that tells you you're in that situation. Pattern: "In production, this breaks as: [X]. The tell: [Y]." ~90 min across ~60 questions. (Source: Audit #008, 2026-05-27)
...
- [ ] **Add StaffLayerTab scenarios in thin domains** — Experiment Design has 1 scenario (needs SRM, network effects, novelty effect, sequential testing), Feature Engineering has 1 (needs leakage triage, point-in-time debugging). Add 4-6 new scenarios. (Source: Audit #008, 2026-05-27)
- [ ] **Fix IC3 strawman reveals in StaffLayerTab** — IC3 answers are occasionally too obviously wrong. Revise to competent-but-incomplete: something a good mid-level engineer would genuinely say before they'd seen enough failures. (Source: Audit #008, 2026-05-27)
