...
- [~] **Pre-Eval Callout pattern** — partially done (v4.35, 2026-05-31). `.msl-hint` callout added to SystemDesignTab, ModelEvalTab, CausalInferenceTab (5 scenarios each). Remaining: MonitoringTab, MLOpsDeployTab. Same pattern — fires after pick, before reveal.
