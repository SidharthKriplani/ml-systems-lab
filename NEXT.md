...
- **`docs/FEEDBACK_LOG.md`** — empty scaffold for aggregating feedback summaries from FeedbackChip / WhatsApp / LinkedIn DMs / Tally / in-person. Five sections (Themes, Verbatim, Actions taken, Open/triage, Sources to monitor) with usage rules at the top. Created 2026-06-19. Working doc — log every meaningful feedback batch here so patterns surface across sources rather than getting lost in chat threads.
