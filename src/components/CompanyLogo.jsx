...
// 'Other / Not listed'), it falls back to a themed initial badge.
//
// Props:
//   company — the canonical company name
//   size    — square px size for the logo / badge (default 20)
//
// Adopted from HQ/shared/CompanyLogo.jsx. CSS vars mapped to MSL tokens:
//   --surface-2 → --depth  |  --border → --rim  |  --text-muted → --ink-ghost
  ...
  const badge = (
    <span
      ...
      style={{
        ...
        color: 'var(--ink-ghost)', fontWeight: 700,
