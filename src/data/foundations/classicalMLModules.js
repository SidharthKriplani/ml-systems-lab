    ...
    checkQuestions: [
      {
        ...
        options: [
          ...
          `\`B) In a forest every tree predicts from scratch and votes, sharing blind spots. Boosting trains trees in sequence, fixing what's left.\``,
      ...
      },
      {
        ...
        options: [
          ...
          `\`B) AdaBoost reweights misclassified rows; gradient boosting fits each tree to the negative gradient of any loss it's given.\``,
      ...
      },
      {
        ...
        options: [
          ...
          `\`C) A random split lets the model train on future rows and predict past ones; boosting exploits that leakage aggressively, so use a time-based split instead.\``,
