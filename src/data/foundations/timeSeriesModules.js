    ...
    checkQuestions: [
      ...
      },
      {
        ...
        options: [
          ...
          `C) When ADF fails to reject and KPSS also rejects, both results pointing away from clean stationarity can indicate fractional integration or a structural break, and blindly differencing further is not the right fix.`,
    ...
    checkQuestions: [
      {
        ...
        options: [
          `A) α ≈ 0.92 means almost all weight is on recent data, implying near-random-walk dynamics. SES with α ≈ 1 corresponds to ARIMA(0,1,1) with θ = 1−α ≈ 0.08 — forecasts collapse to the last observation.`,
    ...
    checkQuestions: [
      ...
      },
      {
        ...
        options: [
          ...
          `D) Pre=before Jan 15, post=after. Fit BSTS on Germany DAU with France as regressor, extrapolate post-launch. Assumptions: stable relationship, no spillover, adequate pre-period, parallel pre-trends.`,
        ],
        answer: `D`,
      },
      {
