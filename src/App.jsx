...
const FeatureEngTab     = lazyReload(() => import('./tabs/FeatureEngTab.jsx'))
const ModelEvalTab      = lazyReload(() => import('./tabs/ModelEvalTab.jsx'))
const ModelsMathTab     = lazyReload(() => import('./tabs/ModelsMathTab.jsx'))
const SystemDesignTab   = lazyReload(() => import('./tabs/SystemDesignTab.jsx'))
const MonitoringTab     = lazyReload(() => import('./tabs/MonitoringTab.jsx'))
const InterviewPrepTab  = lazyReload(() => import('./tabs/InterviewPrepTab.jsx'))
const GradientTab       = lazyReload(() => import('./tabs/GradientTab.jsx'))
const LandscapeTab      = lazyReload(() => import('./tabs/LandscapeTab.jsx'))
const ClassicalMLTab    = lazyReload(() => import('./tabs/ClassicalMLTab.jsx'))
const MLOpsDeployTab    = lazyReload(() => import('./tabs/MLOpsDeployTab.jsx'))
const MLOpsPipelinesTab = lazyReload(() => import('./tabs/MLOpsPipelinesTab.jsx'))
const DeepLearningTab   = lazyReload(() => import('./tabs/DeepLearningTab.jsx'))
const DLFineTuningTab   = lazyReload(() => import('./tabs/DLFineTuningTab.jsx'))
const DLServingTab      = lazyReload(() => import('./tabs/DLServingTab.jsx'))
const CausalInferenceTab = lazyReload(() => import('./tabs/CausalInferenceTab.jsx'))
const TimeSeriesTab     = lazyReload(() => import('./tabs/TimeSeriesTab.jsx'))
const AirflowTab        = lazyReload(() => import('./tabs/AirflowTab.jsx'))
const DbtTab            = lazyReload(() => import('./tabs/dbtTab.jsx'))
const DataModelingTab   = lazyReload(() => import('./tabs/DataModelingTab.jsx'))
const TakeHomeTab    = lazyReload(() => import('./tabs/TakeHomeTab.jsx'))
const TrainerTab     = lazyReload(() => import('./tabs/TrainerTab.jsx'))
const CombinatorTab  = lazyReload(() => import('./tabs/CombinatorTab.jsx'))
const DrillTab       = lazyReload(() => import('./tabs/DrillTab.jsx'))
const InterviewQuestionsTab = lazyReload(() => import('./tabs/InterviewQuestionsTab.jsx'))
const CompanyTracksTab = lazyReload(() => import('./tabs/CompanyTracksTab.jsx'))
const ReviewTab = lazyReload(() => import('./tabs/ReviewTab.jsx'))
const AboutTab = lazyReload(() => import('./tabs/AboutTab.jsx'))
const CodeBugsTab    = lazyReload(() => import('./tabs/CodeBugsTab.jsx'))
const CaseStudiesTab = lazyReload(() => import('./tabs/CaseStudiesTab.jsx'))
const StaffLayerTab  = lazyReload(() => import('./tabs/StaffLayerTab.jsx'))
...
const FraudDetectionTab = lazyReload(() => import('./tabs/FraudDetectionTab.jsx'))
const BehavioralBankTab = lazyReload(() => import('./tabs/BehavioralBankTab.jsx'))
const RankingProjectTab = lazyReload(() => import('./tabs/RankingProjectTab.jsx'))
const ForecastProjectTab = lazyReload(() => import('./tabs/ForecastProjectTab.jsx'))
const NLPContentProjectTab = lazyReload(() => import('./tabs/NLPContentProjectTab.jsx'))
const StartHereTab      = lazyReload(() => import('./tabs/StartHereTab.jsx'))
const BuildHubTab       = lazyReload(() => import('./tabs/BuildHubTab.jsx'))
const DrillBrowser      = lazyReload(() => import('./components/judge/DrillBrowser.jsx'))
const PlansTab          = lazyReload(() => import('./tabs/PlansTab.jsx'))
const ProfilePage       = lazyReload(() => import('./tabs/ProfilePage.jsx'))
...
const ProgressTab       = lazyReload(() => import('./tabs/ProgressTab.jsx').then(m => ({ default: m.ProgressTab })))
// Foundation runners (all named exports)
const MathStatsFoundationTab      = lazyReload(() => import('./tabs/foundations/MathStatsFoundationTab.jsx').then(m => ({ default: m.MathStatsFoundationTab })))
const ClassicalMLFoundationTab    = lazyReload(() => import('./tabs/foundations/ClassicalMLFoundationTab.jsx').then(m => ({ default: m.ClassicalMLFoundationTab })))
const EvalFoundationTab           = lazyReload(() => import('./tabs/foundations/EvalFoundationTab.jsx').then(m => ({ default: m.EvalFoundationTab })))
const UnsupervisedFoundationTab   = lazyReload(() => import('./tabs/foundations/UnsupervisedFoundationTab.jsx').then(m => ({ default: m.UnsupervisedFoundationTab })))
const CausalFoundationTab         = lazyReload(() => import('./tabs/foundations/CausalFoundationTab.jsx').then(m => ({ default: m.CausalFoundationTab })))
const ProductionFoundationTab     = lazyReload(() => import('./tabs/foundations/ProductionFoundationTab.jsx').then(m => ({ default: m.ProductionFoundationTab })))
const MonitoringFoundationTab     = lazyReload(() => import('./tabs/foundations/MonitoringFoundationTab.jsx').then(m => ({ default: m.MonitoringFoundationTab })))
const SystemDesignFoundationTab   = lazyReload(() => import('./tabs/foundations/SystemDesignFoundationTab.jsx').then(m => ({ default: m.SystemDesignFoundationTab })))
const RecSysFoundationTab         = lazyReload(() => import('./tabs/foundations/RecSysFoundationTab.jsx').then(m => ({ default: m.RecSysFoundationTab })))
const PricingFoundationTab        = lazyReload(() => import('./tabs/foundations/PricingFoundationTab.jsx').then(m => ({ default: m.PricingFoundationTab })))
const DeepLearningFoundationTab   = lazyReload(() => import('./tabs/foundations/DeepLearningFoundationTab.jsx').then(m => ({ default: m.DeepLearningFoundationTab })))
// New foundation runners — 6 additional domains
const RLFoundationTab             = lazyReload(() => import('./tabs/foundations/RLFoundationTab.jsx').then(m => ({ default: m.RLFoundationTab })))
const TimeSeriesFoundationTab     = lazyReload(() => import('./tabs/foundations/TimeSeriesFoundationTab.jsx').then(m => ({ default: m.TimeSeriesFoundationTab })))
const SelfSupervisedFoundationTab = lazyReload(() => import('./tabs/foundations/SelfSupervisedFoundationTab.jsx').then(m => ({ default: m.SelfSupervisedFoundationTab })))
const GraphMLFoundationTab        = lazyReload(() => import('./tabs/foundations/GraphMLFoundationTab.jsx').then(m => ({ default: m.GraphMLFoundationTab })))
const BanditsFoundationTab        = lazyReload(() => import('./tabs/foundations/BanditsFoundationTab.jsx').then(m => ({ default: m.BanditsFoundationTab })))
const ProbabilisticMLFoundationTab = lazyReload(() => import('./tabs/foundations/ProbabilisticMLFoundationTab.jsx').then(m => ({ default: m.ProbabilisticMLFoundationTab })))
const OptimizationFoundationTab    = lazyReload(() => import('./tabs/foundations/OptimizationFoundationTab.jsx').then(m => ({ default: m.OptimizationFoundationTab })))
const DataFoundationTab            = lazyReload(() => import('./tabs/foundations/DataFoundationTab.jsx').then(m => ({ default: m.DataFoundationTab })))
const MyTracksTab                  = lazyReload(() => import('./tabs/MyTracksTab.jsx').then(m => ({ default: m.MyTracksTab })))
