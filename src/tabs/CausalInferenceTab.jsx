          ...
          <div key={s.id} style={{ border: `1px solid ${it.open ? accentColor + '55' : 'rgba(255,255,255,0.15)'}`, borderRadius: '12px', overflow: 'hidden', background: it.open ? accentColor + '04' : 'transparent' }}>
            ...
            {it.open && (
              <div style={{ padding: '0 16px 16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                {it.revealed && (
                  <div style={{ padding: '12px 14px', background: 'var(--card-scrim)', border: `1px solid ${isCorrect ? 'rgba(52,211,153,0.2)' : 'rgba(244,63,94,0.2)'}`, borderRadius: '8px' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
      ...
      {activeModuleData && (
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          <BookmarkButton tabId="causal" moduleId={active} label={activeModuleData.label} />
        </div>
      )}
