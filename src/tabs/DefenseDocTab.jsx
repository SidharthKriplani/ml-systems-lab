...
export default function DefenseDocTab({ onNavigate, isUnlocked, onUnlock }) {
  ...
  return (
    <div style={{ maxWidth: 700, margin: '0 auto', padding: '32px 20px' }} className="defense-doc-print">
      ...
      {/* Progress bar */}
      {totalItems > 0 && (
        <div style={{ marginBottom: 24, padding: 'var(--card-pad-primary)', background: 'var(--card-scrim)', border: '1px solid var(--rim)', borderRadius: 8, display: 'flex', alignItems: 'center', gap: 10 }}>
