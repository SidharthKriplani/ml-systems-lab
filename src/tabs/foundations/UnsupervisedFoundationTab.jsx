...
import { markModuleDone, isModuleDone, getDoneCount, unmarkModuleDone } from '../../utils/foundations/unsupervisedFoundationProgress.js'
...
export function UnsupervisedFoundationTab({ onNavigate, openModuleId, navOrigin }) {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          ...
          <p style={{ fontSize: '0.8rem', color: 'var(--ink-low)', margin: '0.4rem 0 0', lineHeight: 1.4 }}>
            Clustering, dimensionality reduction, and anomaly detection — structure without labels.
          </p>
          {/* Progress bar */}
