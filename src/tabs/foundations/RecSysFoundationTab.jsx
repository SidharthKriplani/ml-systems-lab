...
export function RecSysFoundationTab({ onNavigate, openModuleId, navOrigin }) {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          ...
          <p style={{ fontSize: '0.8rem', color: 'var(--ink-low)', margin: '0.4rem 0 0', lineHeight: 1.4 }}>
            Two-stage architecture, two-tower retrieval, learning-to-rank, cold start, feedback-loop bias, and offline vs online evaluation.
          </p>
