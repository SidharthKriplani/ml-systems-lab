...
export function ProductionFoundationTab({ onNavigate }) {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          <h2 style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--ink-hi)', margin: 0, letterSpacing: '-0.02em' }}>
            Feature Eng & Production Foundations
          </h2>
          <p style={{ fontSize: '0.8rem', color: 'var(--ink-low)', margin: '0.4rem 0 0', lineHeight: 1.4 }}>
            Training-serving skew, feature stores, pipeline architecture, and data quality in production.
          </p>
