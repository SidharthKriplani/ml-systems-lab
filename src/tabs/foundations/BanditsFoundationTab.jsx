...
export function BanditsFoundationTab({ onNavigate, openModuleId }) {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          <h2 style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--ink-hi)', margin: 0, letterSpacing: '-0.02em' }}>
            Bandits & Exploration Foundations
          </h2>
          <p style={{ fontSize: '0.8rem', color: 'var(--ink-low)', margin: '0.4rem 0 0', lineHeight: 1.4 }}>
            UCB, Thompson sampling, contextual bandits, LinUCB, OPE, and exploration in recsys.
          </p>
