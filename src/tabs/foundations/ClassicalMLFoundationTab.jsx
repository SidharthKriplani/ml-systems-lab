...
export function ClassicalMLFoundationTab({ onNavigate, openModuleId, navOrigin }) {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          ...
          <p style={{ fontSize: '0.8rem', color: 'var(--ink-low)', margin: '0.4rem 0 0', lineHeight: 1.4 }}>
            Linear models, tree-based methods, SVMs, and the theory of generalization.
          </p>
          {/* Progress bar */}
      ...
      {selected && (
        <div ref={contentRef} style={{ flex: 1, overflowY: 'auto', padding: '1.75rem 2rem', background: 'var(--depth)', minWidth: 0 }}>
          ...
          <div style={{ background: 'var(--surface)', border: '1px solid var(--rim)', borderRadius: '10px',
            ...
            {renderMd(selected.summary, { fontSize: '0.9rem', color: 'var(--ink-mid)', lineHeight: 1.7, margin: 0 }, selected.figures || {}, selected.id)}
          </div>
