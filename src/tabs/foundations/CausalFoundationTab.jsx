...
import { markModuleDone, isModuleDone, getDoneCount, unmarkModuleDone } from '../../utils/foundations/causalFoundationProgress.js'
...
export function CausalFoundationTab({ onNavigate }) {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          ...
          <p style={{ fontSize: '0.8rem', color: 'var(--ink-low)', margin: '0.4rem 0 0', lineHeight: 1.4 }}>
            Potential outcomes, DAGs, experiment design, and uplift modeling for production decisions.
          </p>
          {/* Progress bar */}
