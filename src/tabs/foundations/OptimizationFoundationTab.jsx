...
export function OptimizationFoundationTab({ onNavigate, openModuleId }) {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          ...
          <p style={{ fontSize: '0.8rem', color: 'var(--ink-low)', margin: '0.4rem 0 0', lineHeight: 1.4 }}>
            Gradient descent, momentum, Adam, learning rate schedules, loss landscapes, and gradient flow.
          </p>
