...
export function DeepLearningFoundationTab({ onNavigate, openModuleId }) {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          ...
          <p style={{ fontSize: '0.8rem', color: 'var(--ink-low)', margin: '0.4rem 0 0', lineHeight: 1.4 }}>
            Neural net fundamentals, backprop, attention, transformers, fine-tuning, and DL in production.
          </p>
