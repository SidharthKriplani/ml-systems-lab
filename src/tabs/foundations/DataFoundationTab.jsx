...
export function DataFoundationTab({ onNavigate }) {
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          ...
          <p style={{ fontSize: '0.8rem', color: 'var(--ink-low)', margin: '0.4rem 0 0', lineHeight: 1.4 }}>
            Data quality, feature engineering, encoding, scaling, imbalance, distribution shift, and leakage.
          </p>
          ...
          return (
            ...
            >
              ...
              <div style={{ minWidth: 0 }}>
                <div style={{ fontSize: '0.83rem', fontWeight: 600, color: done ? 'var(--ink-mid)' : 'var(--ink-hi)', lineHeight: 1.3 }}>{m.title}</div>
