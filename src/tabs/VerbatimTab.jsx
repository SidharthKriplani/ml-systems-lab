...
const QUESTIONS = [
  ...
  { id: 26, category: 'System Design', text: 'Design a real-time anomaly detection system for financial transactions processing 500k events per second.' },
  { id: 27, category: 'System Design', text: 'Walk me through the architecture of a two-tower retrieval system. How does it scale to 1 billion items?' },
  { id: 28, category: 'System Design', text: 'How would you design an ML platform that allows 200 data scientists to train and deploy models independently?' },
  { id: 29, category: 'System Design', text: 'Design a feature store. How do you ensure point-in-time correctness and handle backfills?' },
  { id: 30, category: 'System Design', text: 'How would you build a streaming pipeline that computes features for a real-time fraud model?' },
  { id: 31, category: 'System Design', text: 'Design a model serving infrastructure that handles 10 models with different latency SLOs (10ms to 500ms).' },
  { id: 32, category: 'System Design', text: 'Walk me through how you\'d build a personalized search ranking system from scratch.' },
  { id: 33, category: 'System Design', text: 'How would you design a system to detect data drift in 500 production models simultaneously?' },
  { id: 34, category: 'System Design', text: 'Design the ML infrastructure for a marketplace that needs to jointly optimize seller revenue and buyer experience.' },
  { id: 35, category: 'System Design', text: 'How would you architect a continual learning system that retrains a model every hour without downtime?' },
  { id: 36, category: 'Technical', text: 'Explain the math behind XGBoost. What loss function does it optimize and how does it handle regularization?' },
  { id: 37, category: 'Technical', text: 'What is the difference between L1 and L2 regularization? When does L1 produce sparsity and why?' },
  { id: 38, category: 'Technical', text: 'Walk me through backpropagation. How does the chain rule apply across layers?' },
  { id: 39, category: 'Technical', text: 'What is batch normalization? Why does it help training and what are its failure modes?' },
  { id: 40, category: 'Technical', text: 'Explain NDCG. How is it computed, and why do we use it for ranking instead of AUC?' },
  { id: 41, category: 'Technical', text: 'What is the reparameterization trick in VAEs and why is it necessary?' },
  { id: 42, category: 'Technical', text: 'Explain how transformer attention works. What is the computational complexity and how does multi-head attention help?' },
  { id: 43, category: 'Technical', text: 'What is the difference between MLE and MAP estimation? When does MAP reduce to L2 regularization?' },
  { id: 44, category: 'Technical', text: 'Walk me through how gradient boosting works. How does it differ from random forest?' },
  { id: 45, category: 'Technical', text: 'What is the curse of dimensionality and how does it affect kNN, SVM, and neural networks differently?' },
  { id: 46, category: 'Technical', text: 'Explain RLHF. What is the reward model, and what does Goodhart\'s Law mean in this context?' },
  { id: 47, category: 'Technical', text: 'What is a Gaussian Process? When would you use one instead of a neural network?' },
  { id: 48, category: 'Behavioral', text: 'Tell me about a time you disagreed with your team on a modeling decision. How did you resolve it?' },
  { id: 49, category: 'Behavioral', text: 'Describe a situation where a model you shipped caused an unexpected negative outcome. What happened?' },
  { id: 50, category: 'Behavioral', text: 'How do you handle a stakeholder who wants to launch a model you don\'t think is ready?' },
  { id: 51, category: 'Behavioral', text: 'Tell me about the most ambiguous ML problem you\'ve worked on. How did you scope it?' },
  { id: 52, category: 'Behavioral', text: 'Describe how you\'ve mentored someone on your team through a difficult technical problem.' },
  { id: 53, category: 'Behavioral', text: 'How do you prioritize between improving an existing model vs. building a new system?' },
  { id: 54, category: 'Case Study', text: 'Your recommendation model\'s click-through rate improved 8% in A/B test but revenue per user dropped 3%. What do you investigate?' },
  { id: 55, category: 'Case Study', text: 'A newly trained model performs worse than the 6-month-old model on all offline metrics. How do you debug this?' },
  { id: 56, category: 'Case Study', text: 'Feature importance shows your top feature is the user\'s city, but your model is supposed to be city-agnostic. What\'s happening?' },
  { id: 57, category: 'Case Study', text: 'After deployment, your fraud model\'s precision dropped from 72% to 41% in 2 weeks. Walk through your investigation.' },
  { id: 58, category: 'Case Study', text: 'A data scientist reports a 95% accurate NLP classifier. When you deploy it, accuracy is 62%. What do you look at first?' },
  { id: 59, category: 'Case Study', text: 'Your A/B test shows no significant effect but your PM is convinced the feature works. How do you respond?' },
  { id: 60, category: 'Trade-offs', text: 'What are the tradeoffs between a single large model vs. a cascade of smaller specialized models?' },
  { id: 61, category: 'Trade-offs', text: 'When would you choose LightGBM over a deep learning model for a tabular prediction task?' },
  { id: 62, category: 'Trade-offs', text: 'What are the tradeoffs between online feature computation and precomputed batch features?' },
  { id: 63, category: 'Trade-offs', text: 'How do you decide between building an in-house solution vs. using a vendor ML tool?' },
  { id: 64, category: 'Trade-offs', text: 'What are the tradeoffs between a two-stage retrieval + ranking pipeline vs. end-to-end learned ranking?' },
  { id: 65, category: 'Trade-offs', text: 'When is it better to have a simpler, explainable model even if a black-box model has 5% better AUC?' },
];
